...
CUL_CLASS_DECL extern void deskey(unsigned char *, short);
/*		      hexkey[8]     MODE
...
CUL_CLASS_DECL extern void usekey(unsigned long *);
/*		    cookedkey[32]
 * Loads the internal key register with the data in cookedkey.
 */

CUL_CLASS_DECL extern void cpkey(unsigned long *);
/*		   cookedkey[32]
 * Copies the contents of the internal key register into the storage
 * located at &cookedkey[0].
 */

CUL_CLASS_DECL extern void des(unsigned char *, unsigned char *);
/*		    from[8]	      to[8]
...
CUL_CLASS_DECL extern void des2key(unsigned char *, short);
/*		      hexkey[16]     MODE
...
CUL_CLASS_DECL extern void Ddes(unsigned char *, unsigned char *);
/*		    from[8]	      to[8]
...
CUL_CLASS_DECL extern void D2des(unsigned char *, unsigned char *);
/*		    from[16]	      to[16]
 * Encrypts/Decrypts (according to the keyS currently loaded in the
...
CUL_CLASS_DECL extern void makekey(char *, unsigned char *);
...
CUL_CLASS_DECL extern void make2key(char *, unsigned char *);
...
CUL_CLASS_DECL extern void use2key(unsigned long *);
/*		    cookedkey[64]
 * Loads the internal key registerS with the data in cookedkey.
 * NOTE: this clobbers all three key registers!
 */

CUL_CLASS_DECL extern void cp2key(unsigned long *);
/*		   cookedkey[64]
...
CUL_CLASS_DECL extern void des3key(unsigned char *, short);
/*		      hexkey[24]     MODE
 * Sets the internal key registerS according to the hexadecimal
...
CUL_CLASS_DECL extern void use3key(unsigned long *);
/*		    cookedkey[96]
 * Loads the 3 internal key registerS with the data in cookedkey.
 */

CUL_CLASS_DECL extern void cp3key(unsigned long *);
/*		   cookedkey[96]
 * Copies the contents of the 3 internal key registerS into the storage
 * located at &cookedkey[0].
 */

CUL_CLASS_DECL extern void make3key(char *, unsigned char *);
