...
namespace ND91Assistant
{
	...
	{ 
		public:
			...
			//只读属性
			virtual /*UINT*/unsigned int GetFileSize(){return _Mp3Data->GetFileSize();}					 //文件大小
			virtual /*UINT*/unsigned int GetPlayTime() {return _Mp3Data->GetPlayTime();}						 //播放时长
			virtual /*UINT*/unsigned int GetiBitSpeed() {return _Mp3Data->GetiBitSpeed();}					 //码率
			virtual /*UINT*/unsigned int GetSampleRate(){return _Mp3Data->GetSampleRate();}						 //采样率
			virtual /*UINT*/unsigned int GetVolumeAdjustment(){return _Mp3Data->GetVolumeAdjustment();}					 //音量调整
			...
			virtual /*UINT*/unsigned int PropertyGetVolumeAdjustment() {return _Mp3Data->PropertyGetVolumeAdjustment();}						//音量调整
