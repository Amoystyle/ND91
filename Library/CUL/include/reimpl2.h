...
CUL_CLASS_DECL size_t DEFAULT_BLOCK_SIZE();
...
protected:
    ...
    CUL_CLASS_DECL bool _ok_to_recurse() const; //throw();
...
struct regex_access
{
    ...
    CUL_CLASS_DECL static bool _do_match_impl
    (
    ...
    CUL_CLASS_DECL static bool _do_match_with_stack
    (
        rpattern_type const & pat,
        match_param<IterT> & param,
        bool const use_null
