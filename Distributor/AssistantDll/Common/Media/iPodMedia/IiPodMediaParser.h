...
namespace ND91Assistant
{
	...
	public:
		...
		//只读属性
		virtual UINT GetFileSize() = 0;						 //文件大小
		virtual UINT GetPlayTime() = 0;						 //播放时长
		virtual UINT GetiBitSpeed() = 0;					 //码率
		virtual UINT GetSampleRate() = 0;					 //采样率
		virtual UINT GetVolumeAdjustment() = 0;				 //音量调整
		...
		virtual UINT PropertyGetVolumeAdjustment() = 0;					//音量调整
