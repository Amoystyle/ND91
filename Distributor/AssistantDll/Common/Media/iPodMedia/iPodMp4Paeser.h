...
namespace ND91Assistant
{
	...
	{ 
		public:
			...
			//只读属性
			virtual UINT GetFileSize(){return _media->_fileSize;}			                     // 文件大小
			virtual UINT GetPlayTime() {return _Mp4Parser->GetMediaDuration()*1000;}	                         // 播放时长
			virtual UINT GetiBitSpeed() {return 0;}					                             // 码率
			virtual UINT GetSampleRate(){return _media->_nSampleRate;}		                     // 采样率
			virtual UINT GetVolumeAdjustment(){return 0;}					                     // 音量调整
			...
			virtual UINT PropertyGetVolumeAdjustment() {return 0;}						            // 音量调整
