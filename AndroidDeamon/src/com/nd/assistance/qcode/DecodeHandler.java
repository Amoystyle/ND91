...
final class DecodeHandler extends Handler {
  ...
  private void decode(byte[] data, int width, int height) {
    ...
    if (source != null) {
      ...
      try {
        rawResult = multiFormatReader.decode(bitmap);//multiFormatReader.decodeWithState(bitmap);
    ...
    if (rawResult != null) {
      ...
      if (handler != null) {
        Message message = Message.obtain(handler, ZxingCode.decode_succeeded, rawResult);
      ...
      if (handler != null) {
        Message message = Message.obtain(handler, ZxingCode.decode_failed);
        message.sendToTarget();
      }
    }
  }
